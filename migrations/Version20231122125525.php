 ...
 */
final class Version20231122125525 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile DROP user_id, CHANGE date_birth date_birth DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD user_id INT DEFAULT NULL, CHANGE date_birth date_birth DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\'');
